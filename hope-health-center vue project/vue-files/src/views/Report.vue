<template>
  <div class="main-container">
    ...
    <div class="report-actions">
      <button @click="printReport" class="action-btn print-btn">Print Report</button>
      <button @click="exportPDF" class="action-btn export-btn">Export PDF</button>
      <button @click="exportExcel" class="action-btn excel-btn">Export Excel</button>
    </div>
...
export default {
  ...
  methods: {
    generateReport() {
      ...
      this.stats.pending = appointments.filter(a => a.status === 'Pending').length;
      this.stats.completed = appointments.filter(a => a.status === 'Done').length;
    ...
    exportExcel() {
      const csvContent = "data:text/csv;charset=utf-8," + 
        ...
        "Appointments," + this.stats.appointments + "\n" +
